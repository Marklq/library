...
public interface IBookDao {
    ...
    @Insert("insert into j2ee_books(book_id,book_name,book_type,author,press,publish_date,price,register_time,is_borrow)" +
            " values (#{book_id},#{book_name},#{book_type},#{author},#{press},#{publish_date},#{price},#{register_time},#{is_borrow})")
    ...
    @Update("update j2ee_books set register_time = #{register_time},book_name=#{book_name},book_type=#{book_type},author=#{author},press=#{press}," +
            "publish_date=#{publish_date},price=#{price},is_borrow=#{is_borrow}" +
