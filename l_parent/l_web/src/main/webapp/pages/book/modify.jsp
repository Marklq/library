...
<div class="panel admin-panel">
    ...
    <div class="body-content">
        <form method="post" class="form-x"
            ...
            <div class="form-group">
                <div class="label">
                    <label class="text-big text-center text-justify">书籍ID: &nbsp; </label>
                </div>
                <div class="field">
                    <input type="text" class="input w50" value="${book.book_id}" title="书籍ID不可更改" name="book_id"
                           readonly="readonly"/>
                    <div class="tips"></div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="${book.book_Num}" name="book_Num"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
