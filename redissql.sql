...
CREATE TABLE `j2ee_amerce` (
  ...
  `is_pay` int(1) NOT NULL,
  PRIMARY KEY (`amerce_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

/*Data for the table `j2ee_amerce` */

insert  into `j2ee_amerce`(`amerce_id`,`student_id`,`name`,`book_name`,`book_Num`,`money`,`is_pay`) values (2,'2','梅恩2','计算机网络','TQ_2323',4.56,0),(3,'2','梅恩2','大学物理','ME_5353',6,1),(4,'2','梅恩2','计算机网络','TQ_2323',30,1),(5,'2','梅恩2','计算机组成原理','ME_3535',34.08,0),(6,'2','梅恩2','大学物理','ME_5353',34.08,0);
...
insert  into `j2ee_managers`(`id`,`username`,`password`,`phoneNumber`,`sex`,`reg_time`) values ('0722ab62-5c26-4c8b-89c5-64341f0c3e1f','dd','tt','12312341234',0,'2020-06-18'),('08203daf-fe8c-4619-92d6-765c3095ac74','admin','123','12312341234',0,'2020-06-18'),('4820bca7-e99a-4e7d-9581-e561b92cb0cc','tt','tt','12312341234',1,'2020-06-18');
...
insert  into `j2ee_messages`(`id`,`student_id`,`student_name`,`message`,`is_del`,`time`,`phoneNumber`) values (1,'44','dd','书本丢失，',1,'2020-06-18','12312341234'),(2,'23','tt','钱包遗失',0,'2020-06-03','13445672345');
